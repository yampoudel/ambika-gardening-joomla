...
foreach($this->form->getFieldset() as $field): ?>
		...
		<?php if($qq == 17) echo '<span style="font-size: 12px;color: rgb(221, 0, 0);font-style: italic;text-decoration: underline;display: inline-block;margin-left: 0px;">Commercial Version</span><br /><a style="float: none;margin-top: 0px;clear:both;" href="http://creative-solutions.net/joomla/creative-contact-form/demo" target="_blank">See Templates Demo</a>'; ?>
