...
class acyupdateHelper{
	...
	function addUpdateSite(){
		...
		$object->location = 'https://www.acyba.com/component/updateme/updatexml/component-acymailing/version-'.$config->get('version').'/level-'.$config->get('level').'/file-extension.xml';
