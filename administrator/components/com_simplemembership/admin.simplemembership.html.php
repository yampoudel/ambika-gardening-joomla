    ...
    static function edit($section, &$lists, $redirect, $row) {
        ...
        <form id="adminForm" name="adminForm" action="index.php" method="post" >
            ...
            <table class="adminform" width="60%">
                ...
                <tr>
                    <td width="350px"><?php echo  JText::_("COM_SIMPLEMEMBERSHIP_GROUP_EDIT_DESCRIPTION") ; ?>:</td>
                    <td align="left"><textarea class="text_area" name="group_desc"
                                               row="10"><?php if (is_object($row)) echo $row->description; ?></textarea></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td width="350px"><?php echo  JText::_("COM_SIMPLEMEMBERSHIP_GROUP_LINK"); ?>:
                        <span style="float:right;margin-bottom: 10px;">
                            <?php
                            echo mosToolTip( JText::_("COM_SIMPLEMEMBERSHIP_GROUP_LINK_TT_BODY") );
                            ?>
                        </span>
                    </td>
                    <td align="left">
...
class HTML_simplemembership {
    static function add_acl_group_form($option, $lists) {
        ...
        <form action="index.php?option=<?php echo $option; ?>" method="post" name="adminForm" id="adminForm" charset=enctype="multipart/form-data">
    ...
    ?>
        ...
        <table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlistusers">
            <tr class="cat-header">
                ...
                <th align="center" class="title" nowrap="nowrap"><?php echo  JText::_("COM_SIMPLEMEMBERSHIP_LABEL_USERID") ; ?></th>
            ...
            ?>
                <tr class="row<?php echo $i % 2; ?>">
                    ...
                    <td align="center"><?php echo $row->fk_users_id; ?></td>
    ...
    static function showConfiguration($lists, $option) {
        ...
        <form action="index.php" method="post" name="adminForm" id="adminForm">
            ...
            <h2><?php echo  JText::_("COM_SIMPLEMEMBERSHIP_ADMIN_ALLOW_USER_REGISTRATION") ; ?></h2>
            <table class="adminform">
                <tr>
                    <td width="185"><?php echo  JText::_("COM_SIMPLEMEMBERSHIP_SELECT_ALLOW_USER_REGISTRATION") ; ?>:</td>
                    <td width="20"><?php echo mosToolTip( JText::_("COM_SIMPLEMEMBERSHIP_SELECT_ALLOW_USER_REGISTRATION_TT_BODY")); ?></td>
            ...
            <table class="adminform adminform55">
                ...
                <tr>
                    <td width="185"><?php echo  JText::_("COM_SIMPLEMEMBERSHIP_SHOW_DEF_JGROUP") ; ?>:</td>
                    <td width="20"><?php echo mosToolTip( JText::_("COM_SIMPLEMEMBERSHIP_SHOW_DEF_JGROUP_TT_BODY")); ?></td>
                    <td><?php echo $lists['show_def_jgroup']; ?></td>
                    <td colspan="3" ></td>
                </tr>
                <tr>
                    <td colspan="6"><hr /></td>
            ...
            <table class="adminform">
                <tr>
                    <td width="185"><?php echo  JText::_("COM_SIMPLEMEMBERSHIP_ADMIN_EDIT_USER_PROFILE") ;?>:</td>
                    <td width="20"><?php echo mosToolTip( JText::_(
                        "COM_SIMPLEMEMBERSHIP_ADMIN_EDIT_USER_PROFILE_TOOLTIP") ); ?></td>
                    <td><?php echo $lists['change_user_profile']; ?></td>
