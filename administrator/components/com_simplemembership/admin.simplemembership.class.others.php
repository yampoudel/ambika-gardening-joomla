...
class mos_alUserOthers {
    ...
    static function setParams() {
        ...
        $settings.= "\$user_configuration['auto_enabled']='" . $user_configuration['auto_enabled'] . "';\n";
        $settings.= "\$user_configuration['allow_registration']='" . $user_configuration['allow_registration'] . "';\n";
        $settings.= "\$user_configuration['allow_fieldsets']='" . $user_configuration['allow_fieldsets'] . "';\n";
        $settings.= "\$user_configuration['show_def_jgroup']='" . $user_configuration['show_def_jgroup'] . "';\n";
        ...
        $settings .= "\$user_configuration['change_user_profile']='" . $user_configuration['change_user_profile'] . "';\n";
