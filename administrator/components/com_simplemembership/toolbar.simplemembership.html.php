...
class menusimplemembership {
    ...
    static function MENU_DEFAULT() {
        ...
        if($task == "check_package_state" || $task == "set_package_license" ||  $task == "sync_ajax") return;
        ...
        if( checkSMSVersionProFree() == "pro" ) {

        } else addSMSInfoAboutUpdate(); //for free version check
