...
$document->addStyleSheet('plugins/simplemembership/plg_simplemembership_get_houses/buttons.css');
        ...
        if (!function_exists('showMyHouses')){
            ...
            if (file_exists($path)){
                ...
                if (isset($_REQUEST['search'])) {$task='my_houses';}
                elseif (isset($_REQUEST['task'])) {$task=$_REQUEST['task'];}
                ...
                switch ($task){
                    ...
                    case 'property_requests':
                        $_GLOBALS['task'] = $task = "property_requests";
                        $_GLOBALS['option'] = $option = "com_simplemembership";
                        break;
                    case 'property_request':
                        $_GLOBALS['task'] = $task = "property_request";
                        $_GLOBALS['option'] = $option = "com_simplemembership";
                        break;
                    case 'accept_property_requests':
                        $_GLOBALS['task'] = $task = "accept_property_requests";
                        $_GLOBALS['option'] = $option = "com_simplemembership";
                        break;
                    case 'decline_property_requests':
                        $_GLOBALS['task'] = $task = "decline_property_requests";
                        $_GLOBALS['option'] = $option = "com_simplemembership";
                        break;                        
