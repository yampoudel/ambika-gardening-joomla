...
jQuery(function($){
  ...
  $(document).ready(function(){
    ...
    footerHtml += '<a href="https://warptheme.com/documentation/" target="_blank">Documentation</a><span>|</span>';
    footerHtml += '<a href="https://warptheme.com/joomla-templates/" target="_blank">Premium Templates</a><span>|</span>';
    footerHtml += '<a href="https://warptheme.com/extra-addons-pagebuilder/" target="_blank">Extra PageBuilder Add-Ons</a>';
    footerHtml += '<a href="https://warptheme.com/member-area/ticket-system/" target="_blank">Support</a>';
    footerHtml += '</div>';
    footerHtml += '</div>';
